...
#Duplicate of above but for only 2048 features
def load_dataset_One_Video_Features_2048(Test_Video_Path):
...
#AllTest_Video_Path = '/home/anant/DeepLearningAnomalyDetection/output/'
AllTest_Video_Path = '/home/anant/ucfanamoly/AnomalyDetectionCVPR2018/SampleVideos/'
...
weights_path = os.getcwd() + '/weights_L1L2.mat'
...
for iv in range(nVideos):
    ...
    #inputs=load_dataset_One_Video_Features_2048(Test_Video_Path) # 32 segments features for one testing video
